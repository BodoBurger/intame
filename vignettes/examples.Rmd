...
intame.charDollar = intame(spam.fit, spam.data, "charDollar",
  predict.fun = spam.predict, fe_method = "ALE")
summary(intame.charDollar)
plot(intame.charDollar)

plot(computeALE(spam.fit, spam.data, "charDollar", predict.fun = spam.predict))
plot(computePD(spam.fit, spam.data, "charDollar", predict.fun = spam.predict))
plot(computePD(spam.fit, spam.data, "hpl", grid.size = 30,
  predict.fun = spam.predict))
plot(computePD(spam.fit, spam.data, "people", grid.size = 30,
  predict.fun = spam.predict))
```
