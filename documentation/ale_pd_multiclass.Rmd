...
ALE = computeALE(nnet.mod$learner.model, iris, "Petal.Width", K = 20,
  multiclass = TRUE)
plotALE(ALE) + geom_point(data = pred.petwidth.seto,
...
plotPartialDependence(generatePartialDependenceData(nnet.mod, iris.task,
  features = "Petal.Width", n = 20))
plotPD(computePD(nnet.mod$learner.model, iris, "Petal.Width", 
...
```{r}
plotPD(computePD(nnet.mod$learner.model, iris, "Petal.Length",
