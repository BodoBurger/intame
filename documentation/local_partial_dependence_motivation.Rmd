...
plotALE(nnet.ALE) + ggtitle("ALE plot")
```
...
gridExtra::grid.arrange(
  plotPD(computePD(lm.mod$learner.model, dt, "x1", l = 20)) + ggtitle("LPD, l=20"),
  plotPD(computePD(lm.mod$learner.model, dt, "x1", l = 200)) + ggtitle("LPD, l = 200"),
...
l = 20
gridExtra::grid.arrange(
  plotPD(computePD(lm.mod$learner.model, dt, "x2", l = l)),
  plotPD(computePD(lm.mod$learner.model, dt, "x3", l = l)),
  plotPD(computePD(lm.mod$learner.model, dt, "x4", l = l)),
  plotPD(computePD(lm.mod$learner.model, dt, "x5", l = l)),
  ncol = 2)
```
...
```{r}
par(mfrow = c(1,1))
plotPD(computePD(nnet.mod$learner.model, dt, "x5", l = 20, n = 50))
plotPD(computePD(nnet.mod$learner.model, dt, "x5", wp = 2, n = 50))
plotPD(computePD(nnet.mod$learner.model, dt, "x5", n = 100)) # wp=0 --> partial dependence
plotPartialDependence(generatePartialDependenceData(nnet.mod, tsk, "x5",
  n = 100, individual = FALSE))
plotPartialDependence(generatePartialDependenceData(nnet.mod, tsk, "x5",
  n = 10, individual = TRUE))

plotPD(computePD(nnet.mod$learner.model, dt, "x4", l = 20))
plotPD(computePD(nnet.mod$learner.model, dt, "x4", wp = 1, n = 20))
...
plotPD(computePD(nnet.mod$learner.model, dt, "x2", l = 20, n = 50))
plotPD(computePD(nnet.mod$learner.model, dt, "x2", wp = 1))
...
plotPD(computePD(nnet.mod$learner.model, dt, "x1", l = 20, n = 50))
plotPD(computePD(nnet.mod$learner.model, dt, "x1", wp = 4))
...
gridExtra::grid.arrange(
  ...
  plotPD(computePD(nnet.mod$learner.model, dt, "x5", n = 50, l = 20, derivative = TRUE,
...
plotPD(computePD(gbm.mod$learner.model, dt, "x5", l = 20, predict.fun = gbm.pred.fun))
plotPD(computePD(gbm.mod$learner.model, dt, "x5", wp = 1, predict.fun = gbm.pred.fun))
plotPD(computePD(gbm.mod$learner.model, dt, "x5", wp = 0, predict.fun = gbm.pred.fun))
