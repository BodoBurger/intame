...
```{r feature-1}
ALE.x1 = computeALE(nnet.mod$learner.model, df, "x1", grid_size = 30)
plot(ALE.x1, derivative = FALSE)
mean(ALE.x1$fe_f)
PD.x1 = computePD(nnet.mod$learner.model, df, "x1", grid_size = 30, grid_method = "quantile")
plot(PD.x1)
mean(PD.x1$fe_f)
```
...
```{r feature-2}
ALE.x2 = computeALE(nnet.mod$learner.model, df, "x2", grid_size = 30)
plot(ALE.x2)
PD.x2 = computePD(nnet.mod$learner.model, df, "x2", grid_size = 30, grid_method = "quantile")
plot(PD.x2)
